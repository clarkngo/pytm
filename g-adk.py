...
# note: place the cloud function logically inside the VPC perimeter, but keep a distinct boundary for 'Agent vs Tool'
internal_pricing_tool.inBoundary = boundary_vpc
